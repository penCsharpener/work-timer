...
namespace WorkTimer.Persistence.Migrations
{
    ...
    [Migration("20210725192620_AddTotalOverhoursToContract")]
    partial class AddTotalOverhoursToContract
    {
            ...
            modelBuilder.Entity("WorkTimer.Domain.Models.AppRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "1a0d18aa-143c-4487-9ee1-21e646cdb636",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = 2,
                            ConcurrencyStamp = "9b833f7d-5813-4f5d-951e-332c908454b8",
                            Name = "Admin",
