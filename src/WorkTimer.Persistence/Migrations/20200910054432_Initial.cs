    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                WorkDayType = table.Column<int>(nullable: false),
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    name: "FK_WorkDays_Contracts_ContractId",
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    name: "FK_WorkingPeriods_WorkDays_WorkDayId",
        ...
        migrationBuilder.InsertData(
            ...
            values: new object[] { 1, "b3234b04-e72b-4be0-8d17-5123069ad41f", "User", "USER" });

        migrationBuilder.InsertData(
            table: "AspNetRoles",
            columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
            values: new object[] { 2, "c74fb88d-4c00-4680-b9d8-b42cec39e59f", "Admin", "ADMIN" });
        ...
        migrationBuilder.CreateIndex(
            name: "IX_WorkingPeriods_WorkDayId",
